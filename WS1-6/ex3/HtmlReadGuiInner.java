...
public class HtmlReadGuiInner extends JPanel {
	...
	public HtmlReadGuiInner() {
		...
		button.addActionListener(new ActionListener() {
			/**
			 * anonymous inner class that handles with event after the button is
			 * pressed
			 */
			@Override
...
/**
*1.http://www.bbc.co.uk/news/uk-scotland-scotland-business-38536108 
*2.http://www.thetimes.co.uk/edition/comment/population-growth-is-stifling-our-green-and-pleasant-land-6jsndv6tr
*/